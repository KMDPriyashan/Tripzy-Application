...
const PlanPage = () => {
  ...
  const handleViewItinerary = (itinerary) => {
    if (itinerary.planData) {
      ...
      Alert.alert(
        "Sample Itinerary",
        "This is a sample itinerary. Create your own plan to view details!",
      );
    }
  };
      ...
      >
        ...
        <View style={styles.titleSection}>
          ...
          <Text style={styles.subtitle}>
            Start organizing your dream trip with ease—choose destinations, set
            dates, and customize every detail
          </Text>
        </View>
